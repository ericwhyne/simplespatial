...
(function(w){
    ...
    heatmap.prototype = {
        ...
        init: function(){
				...
				// set an ID so we can do stuff with this canvas... ejw
				canvas.setAttribute('id', 'heatmapcanvas');
        ...
        colorize: function(x, y){ //This function is the killer.... 95% of processing on a large data set.
